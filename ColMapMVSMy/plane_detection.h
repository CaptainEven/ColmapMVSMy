...
//const double kFx = 535.4;
//const double kFy = 539.2;
//const double kCx = 320.1;
//const double kCy = 247.6;

const double kFx = 1104.971;
const double kFy = 1104.971;
const double kCx = 1000.0;
const double kCy = 666.50;
const int kDepthWidth = 1960;
const int kDepthHeight = 1330;
...
public:
	...
	// @even: 读取深度图(opencv mat(float))
	bool readDepthMat(const cv::Mat& depth_mat);

	// @even: 读取点云
	bool readCloud(const cv::Mat_<cv::Vec3f>& my_cloud);
